...
import com.mobileprogramming.myfundamentalapp.service.StackWidgetService

class UserFavoriteWidget : AppWidgetProvider() {
    companion object {
        private const val TOAST_ACTION = "com.mobileprogramming.myfundamentalapp.TOAST_ACTION"
        const val EXTRA_ITEM = "com.mobileprogramming.myfundamentalapp.EXTRA_ITEM"
